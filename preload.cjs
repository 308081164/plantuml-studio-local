...
contextBridge.exposeInMainWorld('studio', {
  ...
  bundledFontsStatus: () => ipcRenderer.invoke('studio:bundled-fonts-status'),
  ...
  archRender: (payload) => ipcRenderer.invoke('studio:arch-render', payload),
  runAgentArchDraft: (payload) => ipcRenderer.invoke('studio:agent-arch-draft', payload),
